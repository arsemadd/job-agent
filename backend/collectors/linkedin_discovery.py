...
BOARD_LINKS = [
    ...
    {"name": "Remote Rocketship", "url": "https://www.remoterocketship.com/remote-jobs/", "note": "Live if REMOTE_ROCKETSHIP_API_KEY set"},
    {"name": "Remote Woman", "url": "https://remotewoman.com/", "note": "Live collector (RSS)"},
    {"name": "AI Jobs", "url": "https://theaijobboard.com/", "note": "Live collector (RSS when available)"},
    {"name": "JS Remotely", "url": "https://jsremotely.com/", "note": "Live collector"},
    ...
    {"name": "Toptal", "url": "https://www.toptal.com/", "note": "Vetted freelance network — discovery"},
    {"name": "JobFill.ai", "url": "https://jobfill.ai/", "note": "Application autofill tool — not a job board"},
    {"name": "WorkWave", "url": "https://www.workwave.com/", "note": "Workforce software company — not a remote job board"},
